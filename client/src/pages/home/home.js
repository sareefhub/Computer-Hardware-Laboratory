...
const Home = () => {
  ...
  const borrowingRules = [
    { icon: <Clock className="home-page-icon" />, title: "เวลาการยืม", description: "การรับอุปกรณ์ให้รับอุปกรณ์ตั้งแต่เวลา 10.00-11.00 น." },
    { icon: <Tool className="home-page-icon" />, title: "วิชา Project", description: "สามารถยืมอุปกรณ์แต่ละไม่เกิน 2500 บาท/คน/เทอม" },
    { icon: <Calendar className="home-page-icon" />, title: "ระยะเวลาการยืม", description: "การรับอุปกรณ์ให้รับภายใน 4 วัน นับตั้งแต่เริ่มยืม" },
    { icon: <Timer className="home-page-icon" />, title: "เวลาคืนอุปกรณ์", description: "การคืนอุปกรณ์ ให้คืนตั้งแต่ 10.00 - 11.30 น." },
    { icon: <AlertCircle className="home-page-icon" />, title: "ค่าปรับ", description: "คืนอุปกรณ์ช้าปรับ 10% จากราคาอุปกรณ์ต่อวัน" },
    { icon: <Ban className="home-page-icon" />, title: "ความเสียหาย", description: "อุปกรณ์เสียจากความประมาท นักศึกษาต้องจ่ายค่าซ่อมเอง" },
  ];
